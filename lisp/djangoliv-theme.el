;;; djangoliv-theme.el --- The Djangoliv color theme  -*- lexical-binding: t; -*-
;;;;;;;;;;;;;;;;
;; Theme perso
;;;;;;;;;;;;;;;;
...
(custom-set-faces
 `(line-number-current-line ((t (:foreground "white" :background "#1f3f4f"))))
...
(custom-set-faces
  '(tab-bar ((t (:background "#1f3f4f"))))
 '(tab-line ((t (:background "#1f3f4f"))))
...
(custom-set-faces
 ...
 '(centaur-tabs-selected ((t (:inherit centaur-tabs-default :foreground "gray" :background "#1f3f4f" :bold t :overline "lightgray"))))
 '(centaur-tabs-selected-modified ((t (:inherit centaur-tabs-default :foreground "#c0a5a5" :background "#1f3f4a" :bold t :overline "lightgray"))))
 '(centaur-tabs-unselected ((t (:inherit centaur-tabs-default :foreground "Gray50" :background "#1f3f4f" :bold t))))
 '(centaur-tabs-unselected-modified ((t (:inherit centaur-tabs-default :foreground "#684a4a" :background "#1f3f4f" :bold t)))))
...
;; company
(custom-set-faces
 '(company-box-background ((t (:background "#26495e" :foreground "White"))))
 '(company-tooltip ((t (:background "#26495e" :foreground "White")))) ;; :box "#1c446d"))))

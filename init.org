...
** Initialisation
*dépendances*: [[https://github.com/dholm/tabbar][tabbar.el]] [[https://github.com/mattfidler/tabbar-ruler.el][tabbar-ruler]]
#+BEGIN_SRC emacs-lisp
  ...
  ;; supression raccourcis
  (global-set-key (kbd "C-c C-<up>") nil)
  (global-set-key (kbd "C-c C-<down>") nil)
 #+END_SRC
** groupes
#+BEGIN_SRC emacs-lisp
  ;; tabbar group
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq peep-dired-ignored-extensions '("mkv" "iso" "mp4" "zip" "tgz" "doc" "docx" "pdf" "odt"))
#+END_SRC
*** image-dired
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; ox-twbs
  (autoload 'org-twbs-export-to-html "ox-twbs" nil t)
        ...
        (let ((content (when (buffer-modified-p)
          ...
          (when content
            (let ((buffer-read-only nil))
              ...
              (insert content))))))
    (forward-line (- theLine 1)))
  (global-set-key (kbd "s-C-r") 'revert-sudo)
#+END_SRC
** Tiny-expand
...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'after-change-major-mode-hook
            '(lambda ()
               (highlight-current-line-minor-mode (if (or (equal major-mode 'text-mode) (equal major-mode 'term-mode) (equal major-mode 'logview-mode) (equal major-mode 'palette-mode) (equal major-mode 'help-mode)) 0 1))))
  ;; changer la couleur
...
#+END_SRC
*** mercurial
*dépendances*: [[https://github.com/emacsmirror/ahg][ahg]] [[https://searchcode.com/file/116589788/lisp/scm/hg-status.el][hg-status.el]]
#+BEGIN_SRC emacs-lisp
  ;; ahg
  (require 'ahg)
  (global-unset-key (kbd "C-x m"))
  (global-set-key (kbd "C-x m m") 'ahg-glog)
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq auto-mode-alist
        (cons '("\\.\\(xml\\|XML\\|xsd\\|XSD\\|xsl\\|rng\\|xhtml\\|CR\\)\\'" . nxml-mode)
              auto-mode-alist))
  (defun my-nxml-hook ()
...
#+BEGIN_SRC emacs-lisp
  (require 'pyvenv)
  (pyvenv-activate "~/Outils/python/envs/python3.5/")
#+END_SRC
**** pip requirements

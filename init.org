...
#+BEGIN_SRC emacs-lisp
  ...
  (add-to-list 'auto-mode-alist `(,(expand-file-name "/testLogs/") . logview-mode)) ;; tous les fichiers du repertoire tesLogs
  (custom-set-variables '(logview-additional-submodes
                          (quote (("myFormat" (format . "TIMESTAMP - NAME - LEVEL") (levels . "myLevels") (timestamp) (aliases)))))

...
*dépendances*: [[https://github.com/djangoliv/conf][djangolivTheme.el]]
#+BEGIN_SRC emacs-lisp
  ;; modification de la modeLine
  (load-file "~/.emacs.d/lisp/djangolivTheme.elc")
#+END_SRC
** Registres
  #+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
 ...
 #+END_SRC
*** dired-k
*dépendances* [[ttps://github.com/syohex/emacs-dired-k][dired-k]]
#+BEGIN_SRC emacs-lisp
(require 'dired-k)
...
*dépendances*: [[https://github.com/Fuco1/dired-hacks][dired-hacks]]
#+BEGIN_SRC emacs-lisp
  (require 'dired-narrow) https://github.com/Fuco1/dired-hacks
...
#+END_SRC
*** export
*dépendances* [[https://github.com/kinjo/org-impress-js.el][org-impress.el]] [[https://github.com/marsmining/ox-twbs][ox-twbs]]
#+BEGIN_SRC emacs-lisp
...
** Completion
  ...
  #+END_SRC
** Docker
*dépendances*: [[https://github.com/spotify/dockerfile-mode][dockerfile-mode.el]] [[https://github.com/Silex/docker.el][docker.el]] [[https://github.com/Silex/tabulated-list-extensions][tle]]
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
*** Analyse de code
*dépendances* [[https://github.com/cosmicexplorer/cloc-emacs][cloc]]
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
*** couleurs
*dépendances*: [[https://github.com/djangoliv/conf/blob/master/lisp/my-css-color.el][my-css-color]]
#+BEGIN_SRC emacs-lisp
  (load-file "~/.emacs.d/lisp/my-css-color.elc")
  (defun color-mode ()
    (interactive)
    (if css-color-mode
        (css-color-mode -1)
...
*** Python
**** Initialisation
*dépendances* [[https://github.com/gopar/django-manage][django-manage]] [[https://github.com/emacsmirror/fuzzy-format][fuzzy-format.el]] [[https://github.com/antonj/Highlight-Indentation-for-Emacs][Highlight-Indentation]] [[https://github.com/flycheck/flycheck][flycheck.el]] (init plus haut)
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** pyvenv
*dépendances* [[https://github.com/proofit404/pyenv-mode][pyenv]]
#+BEGIN_SRC emacs-lisp
  (require 'pyvenv)
#+END_SRC
**** pip requirements
...
#+BEGIN_SRC emacs-lisp
  ...
  (eval-after-load "js2-mode" ;; doubleclick selection
      '(progn (define-key js2-mode-map [mouse-1] 'mouse-set-point)))
  (defun angular-js ()
    (interactive)

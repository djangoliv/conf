...
*dépendances* [[https://github.com/grizzl/fiplr][fiplr]] [[https://github.com/emacsattic/ifind-mode][ifind-mode.el]]
#+BEGIN_SRC emacs-lisp
  ;; i-find
...
*** Python
**** Initialisation
*dépendances* [[https://github.com/gopar/django-manage][django-manage]] [[https://github.com/emacsmirror/fuzzy-format][fuzzy-format.el]] [[https://github.com/flycheck/flycheck][flycheck.el]] (init plus haut)
#+BEGIN_SRC emacs-lisp

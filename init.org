...
**** pyvenv
#+BEGIN_SRC emacs-lisp
  (setenv "WORKON_HOME" "~/Tools/python/venv")
  (use-package pyvenv
    :straight t
    :config
    (pyvenv-activate "~/Tools/python/venv/base")
                      ...
                      (if (file-exists-p (replace-regexp-in-string "b/" "" path ))
                        ...
                        (if (file-exists-p (concat "~/workspaces/jupyterlab-projects/jupyterhub-projects/jupyterApps/app" path))
                          ...
                          (if (file-exists-p (concat "~/workspaces/" path))
                            ...
                            (if (file-exists-p (concat "~/workspaces/Mosaic/mosaic-board/" path))
                                (find-file (concat "~/workspaces/Mosaic/mosaic-board/" path))
                            (if (file-exists-p (concat "~/workspaces/codeTympan/code_tympan/" path))
                                (find-file (concat "~/workspaces/codeTympan/code_tympan/" path))
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq browse-url-generic-program "~/Tools/firefox/firefox/firefox"
...
#+BEGIN_SRC emacs-lisp
  ...
  (set-default 'tramp-default-proxies-alist (quote (("django" "sag" "djangoliv" "/ssh:%h:"))))
